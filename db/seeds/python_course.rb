# Python Programming Course - Codecademy Style
puts "Creating Python Programming Course..."
...
python_course = Course.find_or_create_by!(slug: 'python-fundamentals') do |course|
  ...
  course.description = 'Learn Python from scratch with interactive lessons and hands-on coding exercises'
  course.difficulty_level = 'beginner'
  course.certification_track = 'python'
...
lesson1_1 = Lesson.find_or_create_by!(course_module: module1, slug: 'hello-python') do |lesson|
  lesson.title = 'Hello, Python!'
...
lesson2_1 = Lesson.find_or_create_by!(course_module: module2, slug: 'if-statements') do |lesson|
  lesson.title = 'If Statements & Conditions'
  ...
  MARKDOWN
  lesson.key_concepts = ['if statements', 'elif', 'else', 'comparison operators', 'logical operators', 'truthy/falsy']
end
...
module3 = CourseModule.find_or_create_by!(slug: 'lists-data-structures', course: python_course) do |mod|
  ...
  mod.description = 'Work with collections of data using lists, dictionaries, and more'
...
# Lesson 3.1: Lists
lesson3_1 = Lesson.find_or_create_by!(course_module: module3, slug: 'python-lists') do |lesson|
  lesson.title = 'Python Lists'
...
# Link Python labs to modules
puts "Linking Python code labs to course modules..."

python_labs = HandsOnLab.python_labs.order(:sequence_order)
...
if python_labs.count >= 4
  ...
  # Lab 3: Functions/Decorators → Module 1 (for now)
  ModuleItem.find_or_create_by!(
  ...
  # Lab 4: File Processing → Module 2 (for now)
  ModuleItem.find_or_create_by!(
  ...
  puts "Linked #{python_labs.count} code labs to course modules"
end

puts "✅ Python course created successfully!"
puts "   - Course: #{python_course.title}"
puts "   - Modules: #{python_course.course_modules.count}"
puts "   - Lessons: #{Lesson.joins(course_module: :course).where(courses: { id: python_course.id }).count}"
