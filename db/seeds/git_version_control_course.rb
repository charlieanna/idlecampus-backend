# Git & Version Control Mastery Course - Based on StackExchange Demand
puts "Creating Git & Version Control Mastery Course..."

# Create Git Course
git_course = Course.find_or_create_by!(slug: 'git-version-control-mastery') do |course|
  course.title = 'Git & Version Control Mastery'
  course.description = 'Master Git workflows, branching strategies, conflict resolution, and collaborative development'
  course.difficulty_level = 'beginner'
  course.certification_track = nil
  course.published = true
  course.sequence_order = 19
  ...
  course.learning_objectives = JSON.generate([
    ...
    "Use advanced Git features (rebase, cherry-pick, bisect)",
    "Apply Git best practices in team environments",
    "Recover from mistakes and troubleshoot issues"
  ])
...
puts "Created course: #{git_course.title}"

# ==========================================
# MODULE 1: Git Fundamentals
# ==========================================

module1 = CourseModule.find_or_create_by!(slug: 'git-fundamentals', course: git_course) do |mod|
  mod.title = 'Git Fundamentals'
  mod.description = 'Core concepts, basic commands, and repository management'
  mod.sequence_order = 1
  mod.estimated_minutes = 90
  mod.published = true
end

lesson1_1 = CourseLesson.find_or_create_by!(title: "Git Basics and Core Concepts") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['git basics', 'commits', 'staging', 'status', 'log', 'diff', 'gitignore', 'stash', 'remotes']
end
...
module2 = CourseModule.find_or_create_by!(slug: 'branching-merging', course: git_course) do |mod|
  mod.title = 'Branching and Merging'
  mod.description = 'Branch management, merge strategies, and conflict resolution'
...
module3 = CourseModule.find_or_create_by!(slug: 'advanced-git', course: git_course) do |mod|
  mod.title = 'Advanced Git Techniques'
  mod.description = 'Rebase, cherry-pick, bisect, and advanced workflows'
...
module4 = CourseModule.find_or_create_by!(slug: 'git-workflows', course: git_course) do |mod|
  mod.title = 'Collaborative Workflows'
  mod.description = 'Git Flow, GitHub Flow, and team collaboration'
  mod.sequence_order = 4
  mod.estimated_minutes = 90
  mod.published = true
end

puts "  ✅ Created modules for Git course"

puts "\n✅ Git & Version Control Mastery Course Created!"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
puts "📚 Course: #{git_course.title}"
puts "📖 Modules: #{git_course.course_modules.count}"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
