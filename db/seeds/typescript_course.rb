...
puts "Creating TypeScript Fundamentals Course..."

ts_course = Course.find_or_create_by!(slug: 'typescript-fundamentals') do |course|
  course.title = 'TypeScript Fundamentals'
  course.description = 'Master TypeScript for scalable JavaScript applications'
  course.difficulty_level = 'intermediate'
  course.published = true
  course.sequence_order = 30
...
puts "Created course: #{ts_course.title}"

# ==========================================
# MODULE 1: TypeScript Basics
# ==========================================

module1 = CourseModule.find_or_create_by!(slug: 'typescript-basics', course: ts_course) do |mod|
  mod.title = 'TypeScript Basics'
  mod.description = 'Types, interfaces, and TypeScript fundamentals'
...
lesson1_1 = CourseLesson.find_or_create_by!(title: "TypeScript Fundamentals and Type System") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['TypeScript basics', 'type annotations', 'type inference', 'interfaces', 'type aliases', 'arrays', 'tuples', 'enums', 'union types']
end
...
module2 = CourseModule.find_or_create_by!(slug: 'typescript-advanced-types', course: ts_course) do |mod|
  mod.title = 'Advanced Types'
  mod.description = 'Generics, utility types, and advanced type features'
...
lesson2_1 = CourseLesson.find_or_create_by!(title: "Generics and Advanced Types") do |lesson|
  lesson.reading_time_minutes = 35
  lesson.content = <<~MARKDOWN
  ...
  MARKDOWN
  lesson.key_concepts = ['generics', 'type parameters', 'union types', 'intersection types', 'type guards', 'type narrowing', 'utility types', 'Partial', 'Pick', 'Omit', 'Record']
end
...
# ==========================================
# MODULE 3: Real-World TypeScript
# ==========================================

module3 = CourseModule.find_or_create_by!(slug: 'typescript-real-world', course: ts_course) do |mod|
  mod.title = 'Real-World TypeScript'
  mod.description = 'Project setup, React/Node integration, migration strategies'
...
lesson3_1 = CourseLesson.find_or_create_by!(title: "TypeScript in Practice") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['tsconfig.json', 'React with TypeScript', 'Node.js with TypeScript', 'Express typing', 'migration strategies', 'best practices', 'hooks typing', 'event handling']
end
...
puts "\n✅ TypeScript Fundamentals Course Created!"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
puts "📚 Course: #{ts_course.title}"
puts "📖 Modules: #{ts_course.course_modules.count}"
puts "📝 Comprehensive lessons with practical TypeScript examples"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
