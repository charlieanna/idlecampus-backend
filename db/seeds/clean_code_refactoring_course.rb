# Clean Code & Refactoring Course
puts "Creating Clean Code & Refactoring Course..."

clean_course = Course.find_or_create_by!(slug: 'clean-code-refactoring') do |course|
  course.title = 'Clean Code & Refactoring'
  course.description = 'Write maintainable, readable code and improve existing codebases'
  course.difficulty_level = 'intermediate'
  course.published = true
  course.sequence_order = 32
  course.estimated_hours = 24
  course.learning_objectives = JSON.generate([
    "Apply clean code principles",
    "Identify and fix code smells",
    "Refactor legacy code safely",
    "Write self-documenting code",
    "Use naming conventions effectively",
    "Improve code readability and maintainability"
  ])
end

puts "Created course: #{clean_course.title}"

# ========================================
# Module 1: Clean Code Principles
# ========================================

module1 = CourseModule.find_or_create_by!(slug: 'clean-code-principles', course: clean_course) do |mod|
  mod.title = 'Clean Code Principles'
  ...
  mod.learning_objectives = JSON.generate([
    ...
    "Master code formatting and organization"
  ])
end

# Lesson 1.1: Introduction to Clean Code
...
# ========================================
# Module 2: Code Smells & Anti-Patterns
# ========================================

module2 = CourseModule.find_or_create_by!(slug: 'code-smells', course: clean_course) do |mod|
  mod.title = 'Code Smells & Anti-Patterns'
  mod.sequence_order = 2
  mod.estimated_minutes = 120
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Identify common code smells",
    "Recognize anti-patterns in code",
    "Understand the impact of technical debt",
    "Learn when and how to address code smells"
  ])
end

puts "  ✅ Created Module 2: Code Smells & Anti-Patterns"

# ========================================
# Module 3: Refactoring Techniques
# ========================================

module3 = CourseModule.find_or_create_by!(slug: 'refactoring-techniques', course: clean_course) do |mod|
  mod.title = 'Refactoring Techniques'
  mod.sequence_order = 3
  mod.estimated_minutes = 130
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Master essential refactoring techniques",
...
puts "  ✅ Created Module 3: Refactoring Techniques"

puts "  ✅ Created Clean Code course with #{clean_course.course_modules.count} modules\n"
puts "Created course: #{clean_course.title}"
