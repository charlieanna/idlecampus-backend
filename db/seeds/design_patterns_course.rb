...
puts "Creating Design Patterns Course..."

patterns_course = Course.find_or_create_by!(slug: 'design-patterns') do |course|
  course.title = 'Design Patterns & SOLID Principles'
  course.description = 'Master Gang of Four patterns and write maintainable OOP code'
  course.difficulty_level = 'intermediate'
  course.published = true
  course.sequence_order = 23
  ...
  course.learning_objectives = JSON.generate([
    ...
    "Use structural patterns (Adapter, Decorator, Proxy)",
    "Apply behavioral patterns (Observer, Strategy, Command)",
    "Recognize when to use each pattern",
    "Avoid anti-patterns and code smells"
  ])
  course.prerequisites = JSON.generate(["Object-oriented programming fundamentals", "Experience with Python or JavaScript"])
end

puts "Created course: #{patterns_course.title}"

# ==========================================
# MODULE 1: SOLID Principles
# ==========================================

module1 = CourseModule.find_or_create_by!(slug: 'solid-principles', course: patterns_course) do |mod|
  mod.title = 'SOLID Principles'
  mod.description = 'Master the five foundational principles of object-oriented design'
  mod.sequence_order = 1
  mod.estimated_minutes = 120
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Apply Single Responsibility Principle",
    "Design with Open/Closed Principle",
...
lesson1_1 = CourseLesson.find_or_create_by!(title: "SOLID Principles Explained") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['SOLID', 'Single Responsibility', 'Open/Closed', 'Liskov Substitution', 'Interface Segregation', 'Dependency Inversion', 'OOP design']
end
...
quiz1 = Quiz.find_or_create_by!(title: "SOLID Principles Quiz") do |quiz|
  quiz.description = 'Test your understanding of SOLID principles'
...
[
  ...
  {
    question_text: "What does the Open/Closed Principle recommend?",
    question_type: "mcq",
    points: 10,
    options: JSON.generate([
      { text: "Classes should be open for extension but closed for modification", correct: true },
      { text: "Classes should always be open to changes", correct: false },
      { text: "Classes should be closed and never extended", correct: false },
      { text: "Classes should have multiple responsibilities", correct: false }
    ]),
    explanation: "The Open/Closed Principle states that software entities should be open for extension but closed for modification. You should be able to add new functionality without changing existing code.",
    difficulty_level: "medium"
  },
  {
    question_text: "True or False: The Liskov Substitution Principle states that objects of a superclass should be replaceable with objects of a subclass without breaking the application.",
    question_type: "true_false",
    points: 10,
    correct_answer: "true",
    explanation: "True. The Liskov Substitution Principle ensures that subtypes can be substituted for their base types without altering the correctness of the program.",
    difficulty_level: "medium"
  },
  {
    question_text: "Which principle suggests depending on abstractions rather than concrete implementations?",
    question_type: "fill_blank",
    points: 15,
    correct_answer: "Dependency Inversion|Dependency Inversion Principle|DIP",
...
module2 = CourseModule.find_or_create_by!(slug: 'creational-patterns', course: patterns_course) do |mod|
  mod.title = 'Creational Patterns'
  mod.description = 'Singleton, Factory, Abstract Factory, Builder, and Prototype patterns'
  mod.sequence_order = 2
  mod.estimated_minutes = 150
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Implement thread-safe Singleton pattern",
    "Use Factory and Abstract Factory for object creation",
    "Apply Builder pattern for complex objects",
    "Understand when to use Prototype pattern"
  ])
end

lesson2_1 = CourseLesson.find_or_create_by!(title: "Creational Design Patterns") do |lesson|
  lesson.reading_time_minutes = 35
  lesson.content = <<~MARKDOWN
  ...
  MARKDOWN
  lesson.key_concepts = ['Singleton', 'Factory', 'Abstract Factory', 'Builder', 'Prototype', 'creational patterns', 'object creation']
end
...
module3 = CourseModule.find_or_create_by!(slug: 'structural-patterns', course: patterns_course) do |mod|
  mod.title = 'Structural Patterns'
  mod.description = 'Adapter, Decorator, Proxy, Facade, Composite patterns'
  mod.sequence_order = 3
  mod.estimated_minutes = 140
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Use Adapter to make incompatible interfaces work together",
    "Apply Decorator to add functionality dynamically",
    "Implement Proxy for access control and lazy loading",
    "Simplify complex systems with Facade pattern"
  ])
end

lesson3_1 = CourseLesson.find_or_create_by!(title: "Structural Patterns") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['Adapter', 'Decorator', 'Proxy', 'Facade', 'Composite', 'structural patterns', 'interface design']
end
...
module4 = CourseModule.find_or_create_by!(slug: 'behavioral-patterns', course: patterns_course) do |mod|
  mod.title = 'Behavioral Patterns'
  mod.description = 'Observer, Strategy, Command, State, Template Method patterns'
  ...
  mod.learning_objectives = JSON.generate([
    ...
    "Design state machines with State pattern"
  ])
end

lesson4_1 = CourseLesson.find_or_create_by!(title: "Behavioral Patterns") do |lesson|
  lesson.reading_time_minutes = 35
  lesson.content = <<~MARKDOWN
    # Behavioral Patterns
  ...
  MARKDOWN
  lesson.key_concepts = ['Observer', 'Strategy', 'Command', 'State', 'Template Method', 'behavioral patterns', 'object communication']
end
...
puts "\n✅ Design Patterns & SOLID Course Created!"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
puts "📚 Course: #{patterns_course.title}"
puts "📖 Modules: #{patterns_course.course_modules.count}"
puts "📝 Lessons: Comprehensive content with before/after examples"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
