# AUTO-GENERATED from react_advanced_patterns_course.rb
puts "Creating Microlessons for React Hooks Advanced..."

module_var = CourseModule.find_by(slug: 'react-hooks-advanced')
...
puts "✓ Created 6 microlessons for React Hooks Advanced"
