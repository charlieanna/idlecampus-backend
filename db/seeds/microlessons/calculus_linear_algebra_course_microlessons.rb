# AUTO-GENERATED from calculus_linear_algebra_course.rb
puts "Creating Microlessons for Calculus Fundamentals..."

module_var = CourseModule.find_by(slug: 'calculus-fundamentals')
...
puts "✓ Created 2 microlessons for Calculus Fundamentals"
