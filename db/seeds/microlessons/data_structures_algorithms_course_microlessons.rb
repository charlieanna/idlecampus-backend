# AUTO-GENERATED from data_structures_algorithms_course.rb
puts "Creating Microlessons for Complexity Analysis..."

module_var = CourseModule.find_by(slug: 'complexity-analysis')
...
puts "✓ Created 12 microlessons for Complexity Analysis"
