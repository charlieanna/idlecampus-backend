# AUTO-GENERATED from web_performance_course.rb
puts "Creating Microlessons for Performance Fundamentals..."

module_var = CourseModule.find_by(slug: 'performance-fundamentals')
...
puts "✓ Created 6 microlessons for Performance Fundamentals"
