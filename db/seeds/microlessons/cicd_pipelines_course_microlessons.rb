# AUTO-GENERATED from cicd_pipelines_course.rb
puts "Creating Microlessons for Cicd Fundamentals..."

module_var = CourseModule.find_by(slug: 'cicd-fundamentals')
...
puts "✓ Created 6 microlessons for Cicd Fundamentals"
