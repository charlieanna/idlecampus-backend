# AUTO-GENERATED from redis_caching_course.rb
puts "Creating Microlessons for Redis Fundamentals..."

module_var = CourseModule.find_by(slug: 'redis-fundamentals')
...
puts "✓ Created 6 microlessons for Redis Fundamentals"
