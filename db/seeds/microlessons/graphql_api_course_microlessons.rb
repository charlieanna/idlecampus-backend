# AUTO-GENERATED from graphql_api_course.rb
puts "Creating Microlessons for Graphql Fundamentals..."

module_var = CourseModule.find_by(slug: 'graphql-fundamentals')
...
puts "✓ Created 12 microlessons for Graphql Fundamentals"
