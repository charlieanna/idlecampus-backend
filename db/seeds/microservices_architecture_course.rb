...
puts "Creating Microservices Architecture Course..."

ms_course = Course.find_or_create_by!(slug: 'microservices-architecture') do |course|
  course.title = 'Microservices Architecture'
  course.description = 'Design and build distributed microservices systems'
  course.difficulty_level = 'advanced'
  course.published = true
  course.sequence_order = 31
  course.estimated_hours = 38
...
module1 = CourseModule.find_or_create_by!(slug: 'microservices-intro', course: ms_course) do |mod|
  mod.title = 'Microservices Fundamentals'
  mod.description = 'Core principles, service boundaries, and when to use microservices'
  mod.sequence_order = 1
  mod.estimated_minutes = 120
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Understand microservices vs monolith tradeoffs",
    "Define service boundaries using domain-driven design",
    "Choose appropriate communication patterns",
    "Apply API Gateway and service discovery patterns"
  ])
end

lesson1_1 = CourseLesson.find_or_create_by!(title: "Microservices Architecture Principles") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['microservices', 'monolith', 'service boundaries', 'DDD', 'API gateway', 'service discovery', 'synchronous', 'asynchronous']
end
...
# ==========================================
# MODULE 2: Service Decomposition & Design
# ==========================================

module2 = CourseModule.find_or_create_by!(slug: 'service-decomposition', course: ms_course) do |mod|
  mod.title = 'Service Decomposition & Design'
  mod.description = 'Breaking down monoliths, defining APIs, data management strategies'
  mod.sequence_order = 2
  mod.estimated_minutes = 150
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Decompose monolithic applications into services",
    "Design effective service APIs",
...
module3 = CourseModule.find_or_create_by!(slug: 'microservices-communication', course: ms_course) do |mod|
  mod.title = 'Inter-Service Communication'
  mod.description = 'REST, gRPC, message queues, event-driven architecture, distributed transactions'
  mod.sequence_order = 3
  mod.estimated_minutes = 140
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Implement REST and gRPC communication",
...
lesson3_1 = CourseLesson.find_or_create_by!(title: "Communication Patterns") do |lesson|
  lesson.reading_time_minutes = 35
  lesson.content = <<~MARKDOWN
  ...
  MARKDOWN
  lesson.key_concepts = ['REST', 'gRPC', 'RabbitMQ', 'Kafka', 'event-driven', 'Saga pattern', 'circuit breaker', 'Protocol Buffers']
end
...
module4 = CourseModule.find_or_create_by!(slug: 'microservices-deployment', course: ms_course) do |mod|
  mod.title = 'Deployment & Operations'
  mod.description = 'Docker, Kubernetes, service mesh, monitoring, logging, and production best practices'
  mod.sequence_order = 4
  mod.estimated_minutes = 130
  mod.published = true
  mod.learning_objectives = JSON.generate([
    "Containerize microservices with Docker",
    "Deploy and orchestrate with Kubernetes",
    "Implement distributed tracing and logging",
    "Monitor microservices in production",
    "Handle common operational challenges"
  ])
end

lesson4_1 = CourseLesson.find_or_create_by!(title: "Microservices in Production") do |lesson|
  ...
  MARKDOWN
  lesson.key_concepts = ['Docker', 'Kubernetes', 'Istio', 'distributed tracing', 'Jaeger', 'ELK stack', 'Prometheus', 'Grafana', 'observability']
end
...
puts "\n✅ Microservices Architecture Course Created!"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
puts "📚 Course: #{ms_course.title}"
puts "📖 Modules: #{ms_course.course_modules.count}"
puts "📝 Lessons: Comprehensive content with real-world examples"
puts "   - Module 1: Microservices Architecture Principles (35 min)"
puts "   - Module 3: Communication Patterns (35 min)"
puts "   - Module 4: Microservices in Production (30 min)"
puts "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
