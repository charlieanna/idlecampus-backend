...
module Api
  module V1
    module Mathematics
      class MathematicsCoursesController < GenericCoursesController
        # GET /api/v1/mathematics/courses
        def index
          courses = get_courses_by_pattern('mathematics')
          render json: {
            success: true,
        ...
        # GET /api/v1/mathematics/courses/:slug
        def show
        ...
        # GET /api/v1/mathematics/courses/:slug/modules
        def modules
          course = Course.find_by!(slug: params[:slug])
        ...
        # GET /api/v1/mathematics/courses/:course_slug/modules/:module_slug
        def show_module
        ...
        # GET /api/v1/mathematics/labs
        def labs
          labs = get_labs_by_type('mathematics')
          render json: {
            success: true,
        ...
        # GET /api/v1/mathematics/labs/:id
        def lab_show
        ...
        # GET /api/v1/mathematics/quizzes/:quiz_id
        def show_quiz
        ...
        # GET /api/v1/mathematics/quizzes/:quiz_id/questions
        def quiz_questions
          quiz = Quiz.find(params[:quiz_id])
        ...
        # POST /api/v1/mathematics/quizzes/:quiz_id/questions/:question_id/submit
        def submit_answer
        ...
        # GET /api/v1/mathematics/lessons/:lesson_id
        def show_lesson
