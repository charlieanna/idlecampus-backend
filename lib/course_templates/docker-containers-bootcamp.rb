...
# 7-week intensive certification bootcamp (DCA-aligned)
# ~40 hours of content with interactive terminal labs
#
# Usage:
#   rails runner "
#     require './lib/course_builder/dsl'
#     require './lib/course_builder/generator'
#     load './lib/course_templates/docker-containers-bootcamp.rb'
#   "

require_relative '../course_builder/dsl'
require_relative '../course_builder/generator'

puts "🐳 Building Docker Containers Professional Bootcamp..."

bootcamp = CourseBuilder::DSL.define("docker-containers-bootcamp") do
  course(
    ...
    sequence_order: 2,
    learning_objectives: [
      "Master Docker fundamentals from basics to orchestration",
      "Build, run, and manage containers in production environments",
      "Create optimized custom Docker images with Dockerfiles",
      "Implement data persistence strategies with volumes",
      "Configure secure multi-container networking",
      "Orchestrate complex applications with Docker Compose",
      "Prepare comprehensively for Docker Certified Associate (DCA) exam",
      "Deploy production-ready microservices architectures"
    ],
    prerequisites: [
      "Basic command-line knowledge (terminal/bash)",
    ...
    mod "Week 1: Introduction to Containers & Docker 🚀" do
      description "Understand containerization fundamentals, Docker architecture, and the relationship between images and containers"
      ...
      learning_objectives(
        ...
        "Run your first Docker container successfully"
      )

      # Lesson 1.1: What are Containers?
      lesson "What are Containers?" do
        ...
        reading_time 15
        key_concepts "containers", "isolation", "portability", "consistency", "microservices"
      end
      ...
      lesson "Containers vs Virtual Machines" do
        ...
        reading_time 15
        key_concepts "virtual machines", "architecture", "performance", "isolation", "security"
      end

      # Lesson 1.3: Introduction to Docker
      lesson "Introduction to Docker" do
        ...
        reading_time 20
        key_concepts "docker", "architecture", "daemon", "client-server", "docker-hub"
      end

      # Lesson 1.4: Understanding Images vs Containers
      lesson "Understanding Images vs Containers" do
        ...
        reading_time 20
        key_concepts "images", "containers", "layers", "lifecycle", "immutability"
      end

      # Lab 1.1: Hello Container!
      lab "Hello Container!",
        lab_type: "docker",
        format: "terminal",
        difficulty: "easy",
      ...
      quiz "Week 1 Review: Containers & Docker Fundamentals",
        ...
        passing_score: 70,
        max_attempts: 3,
        quiz_type: "standard" do

        mcq "What is a container?",
          options: [
            { text: "A lightweight, standalone package that includes everything needed to run software", correct: true },
            { text: "A type of virtual machine with its own kernel", correct: false },
            { text: "A cloud storage system for applications", correct: false },
            { text: "A programming language for distributed systems", correct: false }
          ],
          correct: "A lightweight, standalone package that includes everything needed to run software",
        ...
        mcq "What is the main advantage of containers over virtual machines?",
          options: [
            { text: "Containers are faster and more lightweight because they share the host OS kernel", correct: true },
            { text: "Containers provide better security isolation", correct: false },
            { text: "Containers can only run on Linux systems", correct: false },
            { text: "Containers require a hypervisor to run", correct: false }
          ],
          correct: "Containers are faster and more lightweight because they share the host OS kernel",
        ...
        mcq "What is the Docker daemon responsible for?",
          options: [
            { text: "Managing Docker objects like containers, images, networks, and volumes", correct: true },
            { text: "Providing the command-line interface for users", correct: false },
            { text: "Storing Docker images in the cloud", correct: false },
            { text: "Compiling application source code", correct: false }
          ],
          correct: "Managing Docker objects like containers, images, networks, and volumes",
        ...
        mcq "What is the relationship between Docker images and containers?",
          options: [
            { text: "An image is a template, and containers are running instances of images", correct: true },
            { text: "Images and containers are the same thing", correct: false },
            { text: "Containers are templates for creating images", correct: false },
            { text: "Images run inside containers", correct: false }
          ],
          correct: "An image is a template, and containers are running instances of images",
        ...
        true_false "Docker containers share the host operating system's kernel.",
          correct: true,
          explanation: "True. Unlike VMs, containers share the host OS kernel, which makes them lightweight and fast to start.",
          points: 5,
          difficulty: "easy"

        true_false "When you delete a container, the image it was created from is also deleted.",
          correct: false,
        ...
        true_false "Docker images are mutable and can be changed after creation.",
          correct: false,
        ...
        mcq "What does the command 'docker ps -a' do?",
          options: [
            { text: "Lists all containers, both running and stopped", correct: true },
            { text: "Lists only running containers", correct: false },
            { text: "Lists all Docker images", correct: false },
            { text: "Shows Docker system information", correct: false }
          ],
          correct: "Lists all containers, both running and stopped",
          explanation: "The -a flag shows all containers regardless of their state (running, stopped, exited, etc.).",
          points: 10,
          difficulty: "easy"

        mcq "Which Docker component stores Docker images?",
          options: [
            { text: "Docker Registry (like Docker Hub)", correct: true },
            { text: "Docker Daemon", correct: false },
            { text: "Docker Client", correct: false },
            { text: "Docker Engine", correct: false }
          ],
          correct: "Docker Registry (like Docker Hub)",
          explanation: "Docker registries store Docker images. Docker Hub is the public registry, but private registries also exist.",
          points: 10,
          difficulty: "medium"

        mcq "What happens when you run 'docker run hello-world' for the first time?",
          options: [
            { text: "Docker pulls the image from Docker Hub and runs a container", correct: true },
            { text: "Docker only pulls the image but doesn't run it", correct: false },
            { text: "Docker creates an image locally and runs it", correct: false },
            { text: "The command fails because the image doesn't exist", correct: false }
          ],
          correct: "Docker pulls the image from Docker Hub and runs a container",
    ...
    # ============================================================
    # WEEK 2: RUNNING AND MANAGING CONTAINERS 🏗️
    # ============================================================
    
    mod "Week 2: Running and Managing Containers 🏗️" do
      description "Master container lifecycle management, learn to run containers in different modes, inspect running containers, and manage Docker images effectively"
      ...
      # Week 2 Lessons, Lab, and Quiz will be implemented below
      ...
      lesson "Docker Run Command Deep Dive" do
        ...
        reading_time 20
        key_concepts "docker-run", "container-options", "detached-mode", "port-mapping"
      end
      ...
      lesson "Container Lifecycle Management" do
        ...
        reading_time 15
        key_concepts "lifecycle", "container-states", "restart-policies"
      end
      ...
      lesson "Inspecting and Monitoring Containers" do
        ...
        reading_time 20
        key_concepts "inspect", "monitoring", "logs", "health-checks"
      end
      ...
      lesson "Executing Commands in Containers" do
        ...
        reading_time 15
        key_concepts "docker-exec", "interactive-shell", "debugging"
      end
      ...
      lesson "Managing Docker Images" do
        ...
        reading_time 15
        key_concepts "images", "image-management", "tagging", "cleanup"
      end

      # Lab 2.1: Deploy and Manage Web Server
      lab "Deploy and Manage Web Server",
        lab_type: "docker",
        format: "terminal",
        difficulty: "easy",
        ...
        description <<~DESC
          In this lab, you'll deploy an Nginx web server and practice essential container management skills including starting, stopping, inspecting, and monitoring containers.
        DESC

        step "Run Nginx in Detached Mode",
        ...
        step "View Container Resource Usage",
        ...
        step "Stop the Container Gracefully",
      ...
      # Quiz 2.1: Week 2 Review
      quiz "Week 2 Review: Container Management",
        description: "Test your knowledge of container lifecycle, monitoring, and management",
        passing_score: 70,
        max_attempts: 3 do

        mcq "What does the -d flag do in 'docker run -d nginx'?",
          options: [
            { text: "Runs the container in detached mode (background)", correct: true },
            { text: "Deletes the container after it stops", correct: false },
            { text: "Downloads the image first", correct: false },
            { text: "Enables debugging mode", correct: false }
          ],
          correct: "Runs the container in detached mode (background)",
          explanation: "The -d flag runs containers in detached mode, freeing up your terminal.",
          points: 10

        true_false "docker exec starts a new process inside a running container",
          correct: true,
        ...
        mcq "Which command shows real-time resource usage of containers?",
          options: [
            { text: "docker stats", correct: true },
            { text: "docker top", correct: false },
            { text: "docker inspect", correct: false },
        ...
        mcq "What's the difference between 'docker stop' and 'docker kill'?",
          options: [
            { text: "stop sends SIGTERM (graceful), kill sends SIGKILL (forceful)", correct: true },
            { text: "They do exactly the same thing", correct: false },
            { text: "stop removes the container, kill doesn't", correct: false },
            { text: "kill is slower than stop", correct: false }
          ],
          correct: "stop sends SIGTERM (graceful), kill sends SIGKILL (forceful)",
          explanation: "docker stop allows graceful shutdown (SIGTERM), while docker kill forces immediate termination (SIGKILL).",
          points: 10

        true_false "Removing a container also removes the image it was created from",
          correct: false,
    ...
    mod "Week 3: Docker Images and Dockerfiles 📝" do
      description "Learn to build custom Docker images, write efficient Dockerfiles, and optimize image sizes"
      ...
      lesson "Understanding Image Layers" do
        ...
        reading_time 25
        key_concepts "layers", "caching", "optimization"
      end
      ...
      lesson "Dockerfile Syntax and Best Practices" do
        ...
        reading_time 30
        key_concepts "dockerfile", "instructions", "best-practices"
      end
      ...
      lesson "Building Custom Images" do
        ...
        reading_time 25
        key_concepts "docker-build", "build-context", "multi-stage"
      end

      # Lab 3.1: Build Custom Web Application
      lab "Build Custom Web Application",
        lab_type: "docker",
        format: "terminal",
        difficulty: "medium",
        ...
        step "Verify Image Was Created",
          instruction: "List images to confirm myapp:v1 exists",
          command: "docker images | grep myapp"
      end

      # Quiz 3.1: Week 3 Review
      quiz "Week 3 Review: Docker Images and Dockerfiles",
        description: "Test your knowledge of Dockerfiles, image layers, and building custom images",
        passing_score: 70,
        max_attempts: 3 do

        mcq "What does each instruction in a Dockerfile create?",
          options: [
            { text: "A new layer in the image", correct: true },
            { text: "A new container", correct: false },
            { text: "A new volume", correct: false },
            { text: "A new network", correct: false }
          ],
          correct: "A new layer in the image",
          explanation: "Each Dockerfile instruction creates a new read-only layer in the image.",
          points: 10

        true_false "Docker caches layers during builds to speed up subsequent builds",
          correct: true,
    ...
    mod "Week 4: Data Management with Volumes 💾" do
      description "Learn to persist data beyond container lifecycle using Docker volumes and bind mounts"
      estimated_minutes 240
      learning_objectives(
        "Understand container filesystem ephemeral nature",
      ...
      lesson "Understanding Container Storage" do
        ...
        reading_time 20
        key_concepts "volumes", "persistence", "ephemeral", "storage"
      end

      # Lab 4.1: Working with Volumes
      lab "Working with Volumes",
        lab_type: "docker",
        format: "terminal",
        difficulty: "medium",
        estimated_minutes: 40,
        ...
        step "Use Volume in Container",
          instruction: "Run a container that mounts the volume",
          command: "docker run -d --name db -v mydata:/data postgres:alpine"
      end

      # Quiz 4.1: Week 4 Review
      quiz "Week 4 Review: Data Persistence",
        description: "Test your understanding of volumes and data management",
        passing_score: 70,
        max_attempts: 3 do

        true_false "Data stored in a container's writable layer persists after the container is removed",
          correct: false,
    ...
    mod "Week 5: Networking and Multi-Container Apps 🌐" do
      description "Master Docker networking and connect multiple containers together"
      estimated_minutes 240
      learning_objectives(
      ...
      lesson "Docker Networking Fundamentals" do
        ...
        reading_time 25
        key_concepts "networking", "bridge", "port-mapping", "dns"
      end

      # Lab 5.1: Multi-Container Application
      lab "Multi-Container Application",
        lab_type: "docker",
        format: "terminal",
        difficulty: "medium",
        estimated_minutes: 45,
        category: "networking" do

        description <<~DESC
          Deploy a web application with a separate database container, connected via a custom network.
        DESC

        step "Create Custom Network",
          instruction: "Create a bridge network for the application",
          command: "docker network create myapp-network"

        step "Run Database Container",
      ...
      # Quiz 5.1: Week 5 Review
      quiz "Week 5 Review: Networking",
        description: "Test your knowledge of Docker networking",
        passing_score: 70,
        max_attempts: 3 do

        true_false "Containers on the same custom network can communicate using container names",
          correct: true,
    ...
    mod "Week 6: Docker Compose for Orchestration 🎼" do
      description "Learn to define and run multi-container applications with Docker Compose"
      estimated_minutes 240
      learning_objectives(
      ...
      lesson "Introduction to Docker Compose" do
        ...
        reading_time 30
        key_concepts "docker-compose", "orchestration", "yaml", "services"
      end

      # Lab 6.1: Deploy with Docker Compose
      lab "Deploy with Docker Compose",
        lab_type: "docker",
        format: "terminal",
        difficulty: "medium",
        estimated_minutes: 45,
      ...
      # Quiz 6.1: Week 6 Review
      quiz "Week 6 Review: Docker Compose",
        description: "Test your understanding of Docker Compose",
        passing_score: 70,
        max_attempts: 3 do

        true_false "Docker Compose can manage multiple containers with a single YAML file",
          correct: true,
    ...
    mod "Week 7: Capstone Project & Kubernetes Readiness 🎓" do
      description "Apply everything you've learned in a comprehensive project and prepare for Kubernetes"
      ...
      learning_objectives(
        ...
        "Successfully complete DCA-aligned assessment"
      )
      ...
      lesson "Docker Best Practices Summary" do
        ...
        reading_time 25
        key_concepts "best-practices", "security", "production", "optimization"
      end
      ...
      lesson "Introduction to Kubernetes" do
        ...
        reading_time 20
        key_concepts "kubernetes", "orchestration", "k8s", "scaling"
      end

      # Lab 7.1: Capstone Project
      lab "Capstone: Full-Stack Application",
        lab_type: "docker",
        format: "terminal",
        difficulty: "hard",
        estimated_minutes: 90,
        category: "capstone" do

        description <<~DESC
          Build a complete microservices application with frontend, backend, database, and reverse proxy - all orchestrated with Docker Compose.
        DESC
        ...
        step "Create Backend Dockerfile",
      ...
      # Final Quiz: DCA Certification Readiness
      quiz "Final Assessment: DCA Certification Readiness",
        description: "Comprehensive exam covering all bootcamp topics - Docker Certified Associate aligned",
        passing_score: 80,
        max_attempts: 2 do

        mcq "What is the primary benefit of using multi-stage builds?",
          options: [
            { text: "Reduce final image size by excluding build dependencies", correct: true },
            { text: "Build multiple images simultaneously", correct: false },
            { text: "Create multiple containers from one image", correct: false },
            { text: "Run multiple commands in parallel", correct: false }
          ],
          correct: "Reduce final image size by excluding build dependencies",
        ...
        mcq "Which command shows real-time resource usage for all containers?",
          options: [
            { text: "docker stats", correct: true },
            { text: "docker top", correct: false },
            { text: "docker inspect", correct: false },
        ...
        mcq "What is the difference between CMD and ENTRYPOINT in a Dockerfile?",
          options: [
            { text: "ENTRYPOINT sets the main executable, CMD provides default arguments", correct: true },
            { text: "They are exactly the same", correct: false },
            { text: "CMD runs at build time, ENTRYPOINT at runtime", correct: false },
            { text: "ENTRYPOINT can be overridden, CMD cannot", correct: false }
          ],
          correct: "ENTRYPOINT sets the main executable, CMD provides default arguments",
          explanation: "ENTRYPOINT defines the main command, while CMD provides default arguments that can be overridden.",
          points: 10

        mcq "How do containers on the same custom network communicate?",
          options: [
            { text: "Using container names as hostnames via automatic DNS", correct: true },
            { text: "They cannot communicate", correct: false },
            { text: "Only through exposed ports", correct: false },
            { text: "Only using IP addresses", correct: false }
          ],
          correct: "Using container names as hostnames via automatic DNS",
          explanation: "Docker provides automatic service discovery via DNS on custom networks.",
          points: 10

        mcq "What does 'docker-compose up -d' do?",
          options: [
            { text: "Starts all services in detached mode", correct: true },
            { text: "Stops all services", correct: false },
            { text: "Deletes all containers", correct: false },
            { text: "Downloads all images", correct: false }
          ],
          correct: "Starts all services in detached mode",
          explanation: "The -d flag runs services in the background, freeing up your terminal.",
          points: 10

        true_false "Docker volumes are managed by Docker and persist data beyond container lifecycle",
          correct: true,
          explanation: "True. Volumes are the preferred way to persist data in Docker containers.",
          points: 5

        true_false "Bind mounts are more portable than Docker volumes",
          correct: false,
          explanation: "False. Volumes are more portable as they're managed by Docker and work across all platforms.",
          points: 5

        mcq "Which restart policy ensures a container always restarts unless manually stopped?",
          options: [
            { text: "unless-stopped", correct: true },
            { text: "always", correct: false },
            { text: "on-failure", correct: false },
            { text: "no", correct: false }
          ],
          correct: "unless-stopped",
          explanation: "unless-stopped restarts containers automatically except when manually stopped.",
          points: 10

        mcq "What is the purpose of .dockerignore?",
          options: [
            { text: "Exclude files from the build context to speed up builds", correct: true },
            { text: "Ignore Docker commands", correct: false },
            { text: "Prevent containers from starting", correct: false },
            { text: "Hide images from docker images command", correct: false }
          ],
          correct: "Exclude files from the build context to speed up builds",
          explanation: ".dockerignore prevents unnecessary files from being sent to the Docker daemon, making builds faster.",
          points: 10

        mcq "In a production environment, which image tag should you use?",
          options: [
            { text: "Specific version tags (e.g., nginx:1.21)", correct: true },
            { text: "Always use :latest", correct: false },
            { text: "Never use tags", correct: false },
            { text: "Only use :stable", correct: false }
          ],
          correct: "Specific version tags (e.g., nginx:1.21)",
...
# Generate the course
puts "\n🚀 Generating course in database..."
result = CourseBuilder::Generator.new(bootcamp).generate!

if result[:success]
  puts "\n✅ SUCCESS! Docker Containers Professional Bootcamp created!"
  puts "\n📊 Summary:"
  puts "   Course: #{result[:course].title}"
  puts "   Modules: #{result[:modules].count}"
  result[:modules].each_with_index do |mod, idx|
    item_count = mod.module_items.count
    puts "     #{idx + 1}. #{mod.title} (#{item_count} items)"
  end
  puts "\n🌐 Access at: http://localhost:5002/docker"
else
  puts "\n❌ ERROR: #{result[:error]}"
